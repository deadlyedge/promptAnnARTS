    ...
    <div className="z-30 bg-cover bg-center w-140 m-1 bg-gray-900 rounded shadow static">
      ...
      <div className="mb-1">
        <label className="text-gray-400 text-xs ml-1 italic">
          click <kbd className="rounded border border-gray-400 border-b-2 px-0.5">prompt</kbd> add
          to edit zone or <kbd className="rounded border border-gray-400 border-b-2 px-0.5">+</kbd>{' '}
