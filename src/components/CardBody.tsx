  ...
  return (
    <div className='text-xs'>
      <div className='group/item bg-green-400 bg-opacity-40 block'>
        ...
        <button className='group invisible hover:bg-slate-200 group-hover/item:visible w-4 h-4 duration-100 hover:scale-125 rounded-full bg-lime-300 absolute right-1'>
          <svg
